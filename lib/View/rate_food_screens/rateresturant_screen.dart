...
class RateResturantScreen extends StatefulWidget {
  const RateResturantScreen({super.key});

  @override
  State<RateResturantScreen> createState() => _RateResturantScreenState();
}

class _RateResturantScreenState extends State<RateResturantScreen> {
